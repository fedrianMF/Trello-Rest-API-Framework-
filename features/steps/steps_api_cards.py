"""Module for card steps"""
from behave import step  # pylint: disable=E0611
from assertpy import assert_that


@step(u'DefinesCard "{http_method}" request to "{endpoint}"')
...
@step(u"The requestCard is sent")
...
@step(u'The statusCard code should be {status_code:d}')
