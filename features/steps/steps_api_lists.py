"""Module for list steps"""
from behave import step  # pylint: disable=E0611
from assertpy import assert_that


@step(u'DefinesList "{http_method}" request to "{endpoint}"')
...
@step(u"The requestList is sent")
...
@step(u'The statusList code should be {status_code:d}')
